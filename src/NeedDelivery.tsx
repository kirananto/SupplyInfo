...
class NeedDelivery extends Component<any, any> {
  readonly state = {
    place_name: "",
    address: "",
    location: undefined,
          ...
          <MainContainer>
            <StyledInputContainer>
              ...
              <StyledInput
                ...
                placeholder="Enter the house name and no: "
              />
            ...
            <StyledInputContainer>
              ...
              <StyledInput
                ...
                placeholder="Address to which items to be delivered"
              />
            ...
            <StyledInputContainer>
              ...
              <StyledInput
                ...
                placeholder="List the item to be delivered"
              />
            </StyledInputContainer>
            <StyledInputContainer>
              <Label>
...
export default withRouter(NeedDelivery);
